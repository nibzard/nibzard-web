...
So the headline is not "building is free." The headline is "getting to a working demo is free." Those sound similar. They are not. Building well still matters; the differentiator just moved upstream.
...
So the real story is more interesting, and the thesis survives it. Capability landed in late November. Adoption still waited for the holidays. The packaging was not "free time alone" — it was **capability and free time arriving together**, and both were necessary. Neither alone would have done it.
...
This echoes [Amazon's "working backwards"](https://www.allthingsdistributed.com/2006/11/working_backwards.html), and the echo is intentional. Amazon's version has a specific mechanic: you write the external-facing press release and FAQ *before* any engineering. I am not claiming the full PR/FAQ ritual. I am claiming the spirit — start from the person and the problem, not from the bricks.
...
So here is the uncomfortable summary, tightened from where I started.
