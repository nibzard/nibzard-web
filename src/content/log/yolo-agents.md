...
Yesterday I was exploring how to contribute a new provider to Vercel's agent-browser project. I opened Codex in my usual YOLO mode, full auto without training wheels, and asked it to explore.
...
Meanwhile, the friction *does* hurt. It slows down iteration, breaks flow, and creates a false sense of security.
...
Not the model where the agent acts in a sandbox, someone else reviews, and there's no clear ownership.
...
The answer is better rollbacks, better review gates, and clearer accountability.
