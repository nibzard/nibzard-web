...
The failure modes: entities are wrongly disambiguated, repeated questions have slightly different answers, facts are paraphrased incorrectly, context window is overfilled, no way to audit, ...
...
Most production systems use both embeddings and structure, in hybrid search combining semantic retrieval with structured queries. Research shows a 25-45% improvement in recall when combining both approaches.
