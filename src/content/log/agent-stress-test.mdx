...
A lot of modern engineering practices are held together by human intuition.
...
## We never standardized the "paved road"
...
Because the goal is a system that stays healthy while it moves fast, not maximum throughput.
...
And if you fix the ecosystem and build the paved road, agents become absurdly powerful.
