...
The trade is real, and it's a trade: you get subsidized intelligence, they get your idea maze.
...
This is where I have to correct an earlier version of my own thinking. It's tempting to frame deprecation as a control lever the labs haven't fully pulled. That undersells what's happening. The lever isn't waiting — it's being pulled, hard.
...
Here's the reframe that actually changes the shape of the argument. The bottleneck is not missing inference hardware.
